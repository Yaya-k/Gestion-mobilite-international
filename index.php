...
-->
 ...
 if(!session_id()) {
  ...
  include 'public/php/dbconnection.php';
 require_once('public/php/User.php');

 $user =new User;

 include "public/php/utile.php";
 ?>
<?php
...
if(isset($_POST['submiteMobilityDemand'])){
    ...
    if(isset($_SESSION['user'])){
        ...
        $itInsert=$user->isertNewMobilite($bdd,$ville, $pays, $date_debut, $date_fin,$user->getId(),$statue);
        if($itInsert){
...
<html lang="en">
  ...
  if(isset($_SESSION['email'])){
      include ("public/php/mobiliteUser.php");
  }else{
